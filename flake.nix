{
  ...
  inputs = {
    dotfiles-private.url = "git+ssh://git@codeberg.org/mayrf/dotfiles-private.git?ref=master&shallow=1";
    # dotfiles-private.url = "git+https://codeberg.org/mayr/dotfiles-private.git";
